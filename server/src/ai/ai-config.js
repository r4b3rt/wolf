...
function getWolfAiConfig() {
  return {
    ...
    maxMessageLength: wolfConfig.ai.maxMessageLength,
    maxMemoryItemLength: wolfConfig.ai.maxMemoryItemLength,
    maxMemorySectionLength: wolfConfig.ai.maxMemorySectionLength,
